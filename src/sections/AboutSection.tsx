...
export const AboutSection: React.FC = () => {
  return (
    <section
      id="about"
      className="min-h-screen w-full relative bg-white flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 overflow-hidden"
    >
      ...
      {/* Main About Content */}
      <div className="relative z-20 flex flex-col items-center gap-10 sm:gap-14 md:gap-16 max-w-4xl text-center">
        {/* Heading */}
        <FadeIn delay={0} y={40}>
          <h2
        ...
        {/* Text Block & Contact Button wrapper */}
